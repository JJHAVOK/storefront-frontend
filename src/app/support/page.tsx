  ...
  return (
    <div className="container py-5" style={{ marginTop: '100px', minHeight: '60vh' }}>
        <div className="text-center mb-5">
            <h1 className="fw-bold display-5 mb-3">Help Center</h1>
            <p className="lead text-muted">Browse our knowledge base to find answers.</p>
        </div>
                                ...
                                <ul className="list-unstyled mb-0">
                                    {cat.articles.map((art: any) => (
                                        <li key={art.id} className="mb-2">
                                            <Link href={`/support/${art.slug}`} className="text-decoration-none text-dark d-flex align-items-center">
