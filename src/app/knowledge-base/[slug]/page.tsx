...
export default function ArticleDetail() {
  ...
  if (!article) return (
      <div className="container py-5 mt-5 text-center">
          ...
          <Link href="/knowledge-base" className="btn btn-primary mt-3">Back to Knowledge Base</Link>
      </div>
  );
    ...
    <div className="container py-5" style={{ marginTop: '80px', minHeight: '60vh' }}>
        <nav aria-label="breadcrumb" className="mb-4">
            <ol className="breadcrumb">
                <li className="breadcrumb-item"><Link href="/knowledge-base">Knowledge Base</Link></li>
