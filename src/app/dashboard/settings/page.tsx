                ...
                <form onSubmit={handleSubmit}>
                    <div className="d-flex align-items-center mb-5">
                        <div className="position-relative me-4">
                            ...
                            <label className="position-absolute rounded-circle shadow-sm d-flex align-items-center justify-content-center" style={{ width: '35px', height: '35px', bottom: '0', right: '0', backgroundColor: '#0ea5e9', border: '2px solid white', cursor: 'pointer', zIndex: 100 }}>
                                <span style={{ color: 'white', fontSize: '10px', fontWeight: 'bold' }}>EDIT</span>
